...
* [NebulaGraph](https://github.com/vesoft-inc/nebula) ⭐ 12,348 | 🐛 681 | 🌐 C++ | 📅 2026-05-18 - A high performance distributed Graph database.
* [HugeGraph](https://github.com/apache/incubator-hugegraph) ⭐ 3,152 | 🐛 392 | 🌐 Java | 📅 2026-08-17 - A graph database that supports more than 10+ billion data, high performance and scalability.
...
* [Actionbase](https://github.com/kakao/actionbase) ⭐ 225 | 🐛 37 | 🌐 Kotlin | 📅 2026-08-13 - A database for user interactions (likes, views, follows) represented as graphs, with precomputed reads served in real-time.
...
* [Flink](https://github.com/apache/flink/tree/master/flink-connectors/flink-connector-hbase-2.2) ⭐ 26,269 | 🐛 380 | 🌐 Java | 📅 2026-08-17 - Flink-HBase connector.
* [Beam](https://github.com/apache/beam/tree/master/sdks/java/io/hbase) ⭐ 8,645 | 🐛 3,981 | 🌐 Java | 📅 2026-08-17 - Beam HBase integration.
