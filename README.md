...
* [NebulaGraph](https://github.com/vesoft-inc/nebula) ⭐ 12,350 | 🐛 679 | 🌐 C++ | 📅 2026-05-18 - A high performance distributed Graph database.
* [HugeGraph](https://github.com/apache/incubator-hugegraph) ⭐ 3,154 | 🐛 394 | 🌐 Java | 📅 2026-08-18 - A graph database that supports more than 10+ billion data, high performance and scalability.
...
* [Actionbase](https://github.com/kakao/actionbase) ⭐ 225 | 🐛 40 | 🌐 Kotlin | 📅 2026-08-19 - A database for user interactions (likes, views, follows) represented as graphs, with precomputed reads served in real-time.
...
* [Flink](https://github.com/apache/flink/tree/master/flink-connectors/flink-connector-hbase-2.2) ⭐ 26,272 | 🐛 379 | 🌐 Java | 📅 2026-08-19 - Flink-HBase connector.
* [Beam](https://github.com/apache/beam/tree/master/sdks/java/io/hbase) ⭐ 8,646 | 🐛 3,975 | 🌐 Java | 📅 2026-08-19 - Beam HBase integration.
* [Storm](https://github.com/apache/storm/tree/master/external/storm-hbase) ⭐ 6,698 | 🐛 49 | 🌐 Java | 📅 2026-08-19 - Storm/Trident integration for HBase.
...
* [Kafka](https://github.com/apache/hbase-connectors/tree/master/kafka) ⭐ 246 | 🐛 9 | 🌐 Scala | 📅 2026-07-29 - HBase Kafka proxy.
