...
* [HugeGraph](https://github.com/apache/incubator-hugegraph) ⭐ 3,175 | 🐛 367 | 🌐 Java | 📅 2026-09-09 - A graph database that supports more than 10+ billion data, high performance and scalability.
...
* [Flink](https://github.com/apache/flink/tree/master/flink-connectors/flink-connector-hbase-2.2) ⭐ 26,325 | 🐛 377 | 🌐 Java | 📅 2026-09-09 - Flink-HBase connector.
* [Beam](https://github.com/apache/beam/tree/master/sdks/java/io/hbase) ⭐ 8,659 | 🐛 3,965 | 🌐 Java | 📅 2026-09-09 - Beam HBase integration.
* [Storm](https://github.com/apache/storm/tree/master/external/storm-hbase) ⭐ 6,694 | 🐛 34 | 🌐 Java | 📅 2026-09-09 - Storm/Trident integration for HBase.
...
* [Kafka](https://github.com/apache/hbase-connectors/tree/master/kafka) ⭐ 246 | 🐛 12 | 🌐 Scala | 📅 2026-08-28 - HBase Kafka proxy.
