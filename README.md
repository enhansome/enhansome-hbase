...
* [NebulaGraph](https://github.com/vesoft-inc/nebula) ⭐ 12,372 | 🐛 678 | 🌐 C++ | 📅 2026-05-18 - A high performance distributed Graph database.
* [HugeGraph](https://github.com/apache/incubator-hugegraph) ⭐ 3,167 | 🐛 365 | 🌐 Java | 📅 2026-08-31 - A graph database that supports more than 10+ billion data, high performance and scalability.
...
* [Actionbase](https://github.com/kakao/actionbase) ⭐ 225 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-01 - A database for user interactions (likes, views, follows) represented as graphs, with precomputed reads served in real-time.
...
* [Flink](https://github.com/apache/flink/tree/master/flink-connectors/flink-connector-hbase-2.2) ⭐ 26,321 | 🐛 375 | 🌐 Java | 📅 2026-09-02 - Flink-HBase connector.
* [Beam](https://github.com/apache/beam/tree/master/sdks/java/io/hbase) ⭐ 8,656 | 🐛 3,950 | 🌐 Java | 📅 2026-09-02 - Beam HBase integration.
* [Storm](https://github.com/apache/storm/tree/master/external/storm-hbase) ⭐ 6,697 | 🐛 33 | 🌐 Java | 📅 2026-09-01 - Storm/Trident integration for HBase.
