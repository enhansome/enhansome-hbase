...
* [NebulaGraph](https://github.com/vesoft-inc/nebula) ⭐ 12,383 | 🐛 678 | 🌐 C++ | 📅 2026-09-08 - A high performance distributed Graph database.
...
* [Flink](https://github.com/apache/flink/tree/master/flink-connectors/flink-connector-hbase-2.2) ⭐ 26,333 | 🐛 367 | 🌐 Java | 📅 2026-09-11 - Flink-HBase connector.
* [Beam](https://github.com/apache/beam/tree/master/sdks/java/io/hbase) ⭐ 8,660 | 🐛 3,969 | 🌐 Java | 📅 2026-09-12 - Beam HBase integration.
* [Storm](https://github.com/apache/storm/tree/master/external/storm-hbase) ⭐ 6,695 | 🐛 34 | 🌐 Java | 📅 2026-09-12 - Storm/Trident integration for HBase.
