...
* [asynchbase](https://github.com/OpenTSDB/asynchbase) ⭐ 608 | 🐛 56 | 🌐 Java | 📅 2023-05-19 - Fully asynchronous, non-blocking HBase client.
...
* [HDocDB](https://github.com/rayokota/hdocdb) ⭐ 27 | 🐛 4 | 🌐 Java | 📅 2023-06-14 - HBase as a JSON document database.

#### Entity/JPA

* [HBase ORM](https://github.com/flipkart-incubator/hbase-orm) ⭐ 84 | 🐛 1 | 🌐 Java | 📅 2023-06-14 - A production-grade HBase ORM library.
* [HEntityDB](https://github.com/rayokota/hentitydb) ⭐ 6 | 🐛 1 | 🌐 Java | 📅 2024-09-25 - HBase as an entity database.
* [Kundera](https://github.com/impetus-opensource/Kundera) ⭐ 0 | 🐛 0 | 📅 2025-08-09 - JPA client with support for HBase.
...
* [NebulaGraph](https://github.com/vesoft-inc/nebula) ⭐ 12,381 | 🐛 678 | 🌐 C++ | 📅 2026-09-08 - A high performance distributed Graph database.
* [HugeGraph](https://github.com/apache/incubator-hugegraph) ⭐ 3,175 | 🐛 373 | 🌐 Java | 📅 2026-09-10 - A graph database that supports more than 10+ billion data, high performance and scalability.
...
* [Actionbase](https://github.com/kakao/actionbase) ⭐ 227 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-01 - A database for user interactions (likes, views, follows) represented as graphs, with precomputed reads served in real-time.
...
* [Themis](https://github.com/XiaoMi/themis) ⭐ 227 | 🐛 6 | 🌐 Java | 📅 2023-04-10 - Cross-row/cross-table transactions on HBase based on Google's Percolator.
* [Haeinsa](https://github.com/VCNC/haeinsa) ⭐ 160 | 🐛 19 | 🌐 Java | 📅 2017-02-28 - Multi-row/multi-table transaction library for HBase.
* [Omid](https://github.com/apache/incubator-omid) ⭐ 93 | 🐛 21 | 🌐 Java | 📅 2026-05-15 - Transactional support for HBase.
* [HBase-QoD](https://github.com/algarecu/hbase-0.94.8-qod) ⭐ 1 | 🐛 11 | 🌐 Java | 📅 2022-10-04 - Vector-field consistency for HBase fine-grained transactional inter-DC replication.
* [Tephra](http://tephra.incubator.apache.org) - Globally consistent transactions on top of HBase.

### Integrations

* [Flink](https://github.com/apache/flink/tree/master/flink-connectors/flink-connector-hbase-2.2) ⭐ 26,328 | 🐛 365 | 🌐 Java | 📅 2026-09-10 - Flink-HBase connector.
* [Beam](https://github.com/apache/beam/tree/master/sdks/java/io/hbase) ⭐ 8,659 | 🐛 3,966 | 🌐 Java | 📅 2026-09-10 - Beam HBase integration.
* [Storm](https://github.com/apache/storm/tree/master/external/storm-hbase) ⭐ 6,694 | 🐛 35 | 🌐 Java | 📅 2026-09-10 - Storm/Trident integration for HBase.
...
* [Kafka](https://github.com/apache/hbase-connectors/tree/master/kafka) ⭐ 246 | 🐛 11 | 🌐 Scala | 📅 2026-09-10 - HBase Kafka proxy.
* [Presto](https://github.com/analysys/presto-hbase-connector) ⭐ 241 | 🐛 27 | 🌐 Java | 📅 2023-01-02 - Presto-HBase connector.
* [Apex](https://github.com/apache/apex-malhar/tree/master/contrib/src/test/java/org/apache/apex/malhar/contrib/hbase) ⚠️ Archived - Apex-HBase connector.
* [Crunch](https://github.com/apache/crunch/tree/master/crunch-hbase) ⚠️ Archived - HBase adapters for Crunch.
* [Elasticsearch](https://github.com/mallocator/Elasticsearch-HBase-River) ⭐ 39 | 🐛 0 | 🌐 Java | 📅 2014-03-12 - Elasticsearch import river for HBase.
* [Cascalog](https://github.com/sorenmacbeth/hbase-cascalog) ⭐ 19 | 🐛 1 | 🌐 Clojure | 📅 2017-01-16 - Wrapper around Cascading.HBase for use in Cascalog.
* [Cascading](https://github.com/Cascading/cascading.hbase) ⭐ 10 | 🐛 2 | 🌐 Java | 📅 2018-01-25 - HBase adapters for Cascading.
...
* [Hannibal](https://github.com/sentric/hannibal) ⭐ 172 | 🐛 9 | 🌐 Ruby | 📅 2017-12-22 - Tool to monitor and maintain HBase clusters.
* [h-rider](https://github.com/NiceSystems/hrider) ⭐ 132 | 🐛 10 | 🌐 Java | 📅 2017-04-04 - GUI for viewing and manipulating data in HBase.
...
* [HubSpot HBase support](https://github.com/HubSpot/hbase-support) ⚠️ Archived - Configs and tools for HBase at HubSpot, including Hystrix integration and coprocessors.
