...
* [NebulaGraph](https://github.com/vesoft-inc/nebula) ⭐ 12,400 | 🐛 685 | 🌐 C++ | 📅 2026-09-08 - A high performance distributed Graph database.
* [HugeGraph](https://github.com/apache/incubator-hugegraph) ⭐ 3,186 | 🐛 365 | 🌐 Java | 📅 2026-09-20 - A graph database that supports more than 10+ billion data, high performance and scalability.
...
* [Flink](https://github.com/apache/flink/tree/master/flink-connectors/flink-connector-hbase-2.2) ⭐ 26,353 | 🐛 383 | 🌐 Java | 📅 2026-09-21 - Flink-HBase connector.
* [Beam](https://github.com/apache/beam/tree/master/sdks/java/io/hbase) ⭐ 8,668 | 🐛 3,952 | 🌐 Java | 📅 2026-09-21 - Beam HBase integration.
...
* [Presto](https://github.com/analysys/presto-hbase-connector) ⭐ 240 | 🐛 27 | 🌐 Java | 📅 2023-01-02 - Presto-HBase connector.
