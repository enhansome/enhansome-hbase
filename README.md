...
* [HugeGraph](https://github.com/apache/incubator-hugegraph) ⭐ 3,159 | 🐛 389 | 🌐 Java | 📅 2026-08-28 - A graph database that supports more than 10+ billion data, high performance and scalability.
...
* [Flink](https://github.com/apache/flink/tree/master/flink-connectors/flink-connector-hbase-2.2) ⭐ 26,302 | 🐛 370 | 🌐 Java | 📅 2026-08-28 - Flink-HBase connector.
...
* [Kafka](https://github.com/apache/hbase-connectors/tree/master/kafka) ⭐ 246 | 🐛 10 | 🌐 Scala | 📅 2026-08-28 - HBase Kafka proxy.
